...
public class RLRobotNN extends AdvancedRobot {
    private String saveClassname =  getClass().getSimpleName() + ".txt";

    static private boolean netInitialized = false;
    ...
    static private NeuralNet NN =  new NeuralNet(5, 20, 0.2, 0, 0,1, false);
    ...
    public void onDeath(DeathEvent e) {
        ...
        // HERE NN.backPropagateOnce(x, new double[]{computeQ(currentReward)});
...
//        double prevQ = NN.getOutput(prevStateAction)[0];
//        double currentQ = NN.getOutput(currentStateAction)[0];
//
...
//            if (NN.getOutput(x)[0] > bestQ) {
//                bestQ = NN.getOutput(x)[0];
